...
- [구현 및 검증 기준](#구현-및-검증-기준)
- [성능 개선 요약](#성능-개선-요약)
- [병목 분석 흐름](#병목-분석-흐름)
- [설계 판단](#설계-판단)
- [병목 개선 작업](#병목-개선-작업)
  - [거래 정합성 기준선 확보](#1-거래-정합성-기준선-확보)
  - [WebSocket/Kafka 실시간 전파 병목 분리](#2-websocketkafka-실시간-전파-병목-분리)
  - [오더북 브로드캐스트 락 경합 분리](#3-오더북-브로드캐스트-락-경합-분리)
  - [주문 생성 경로 병목 재분석](#4-주문-생성-경로-병목-재분석)
  - [비동기 주문 접수 전환](#5-비동기-주문-접수-전환---http-응답-대기와-worker-완료-대기-분리)
- [현재 한계](#현재-한계)
- [트러블 슈팅](#트러블-슈팅)
- [기술 스택](#기술-스택)
